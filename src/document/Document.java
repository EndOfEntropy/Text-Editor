...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		/*BasicDocument test = new BasicDocument(getText());
		if(test.getNumWords() > 0 && test.getNumWords() > 0) {
			return 206.835d - (1.015d * (double)test.getNumWords() / (double)test.getNumSentences())
					- (84.6d * (double)test.getNumSyllables() / (double)test.getNumWords());
		}
